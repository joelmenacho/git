...
```
git remote add origin https://github.com/joelmenacho/git.git
```

#### Cambiar URL del repositorio remoto
```
git remote set-url origin https://github.com/joelmenacho/git.git
```
...
```
git clone https://github.com/joelmenacho/git.git
```

#### Clona un repositorio remoto en una rama específica
```
git clone --branch <rama> <https://github.com/joelmenacho/git.git>
